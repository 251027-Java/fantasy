...
public class SleeperTypeReferences {
    private static final TypeReference<List<SleeperMatchupResponse>> MATCHUP_LIST_TYPE =
            new TypeReference<List<SleeperMatchupResponse>>() {};
    private static final TypeReference<Map<String, SleeperPlayerResponse>> PLAYER_MAP_TYPE =
            new TypeReference<Map<String, SleeperPlayerResponse>>() {};
    private static final TypeReference<List<SleeperUserResponse>> USER_LIST_TYPE =
            new TypeReference<List<SleeperUserResponse>>() {};
    private static final TypeReference<List<SleeperRosterUserResponse>> ROSTER_USER_LIST_TYPE =
            new TypeReference<List<SleeperRosterUserResponse>>() {};
    private static final TypeReference<List<SleeperLeagueResponse>> LEAGUE_LIST_TYPE =
            new TypeReference<List<SleeperLeagueResponse>>() {};
    private static final TypeReference<SleeperUsernameResponse> USERNAME_TYPE =
            new TypeReference<SleeperUsernameResponse>() {};
    private static final TypeReference<SleeperNFLStateResponse> NFL_STATE_TYPE =
            new TypeReference<SleeperNFLStateResponse>() {};
