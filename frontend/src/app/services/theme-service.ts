	...
	private readonly statsThemes: Record<ThemeColor, Theme> = {
		red: {
			...
			loadingTableBackgroundClass:
				'bg-[radial-gradient(circle_at_top_right,_#fff5f6,_#ffefef,_#fff7f8)]',
		},
		orange: {
			selectThemeButtonClasses:
				'border-orange-700 bg-orange-500 hover:bg-orange-700',
			backToLeaguesButtonClasses:
				'border-orange-700 bg-orange-900 hover:bg-orange-950',
			...
			loadingTableBackgroundClass:
				'bg-[radial-gradient(circle_at_top_right,_#fff8f0,_#fff3e6,_#fff9f3)]',
		},
		yellow: {
			selectThemeButtonClasses:
				'border-yellow-700 bg-yellow-400 hover:bg-yellow-600',
			backToLeaguesButtonClasses:
				'border-yellow-700 bg-yellow-900 hover:bg-yellow-950',
			...
			loadingTableBackgroundClass:
				'bg-[radial-gradient(circle_at_top_right,_#fffeef,_#fffce6,_#fffef3)]',
		},
		green: {
			selectThemeButtonClasses:
				'border-green-700 bg-green-500 hover:bg-green-700',
			backToLeaguesButtonClasses:
				'border-green-700 bg-green-900 hover:bg-green-950',
			...
			loadingTableBackgroundClass:
				'bg-[radial-gradient(circle_at_top_right,_#f2fff8,_#eafff2,_#f4fff9)]',
		},
		blue: {
			...
			loadingTableBackgroundClass:
				'bg-[radial-gradient(circle_at_top_right,_#f0f7ff,_#e4f0ff,_#ebf5ff)]',
		},
		violet: {
			selectThemeButtonClasses:
			...
			loadingTableBackgroundClass:
				'bg-[radial-gradient(circle_at_top_right,_#faf3ff,_#f5eaff,_#fbf5ff)]',
		},
	} as const;
